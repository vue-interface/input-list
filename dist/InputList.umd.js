(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["InputList"] = factory();
	else
		root["InputList"] = factory();
...
// EXTERNAL MODULE: ./src/css/InputList.css
var InputList = __webpack_require__("9dd9");

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"51d8fe6f-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/InputList.vue?vue&type=template&id=4164b828&
...
// CONCATENATED MODULE: ./src/InputList.vue?vue&type=template&id=4164b828&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/InputList.vue?vue&type=script&lang=js&
...
/* harmony default export */ var InputListvue_type_script_lang_js_ = ({
  directives: {
    bindEvents: {
      inserted: function inserted(el, binding, vnode) {
        var children = Array.from(vnode.elm.children);
        children.forEach(function (child) {
          if (isUndefined(child.value)) {
            child.querySelectorAll('input, textarea, select').forEach(function (input) {
  ...
  props: {
    ...
    validate: {
      type: Function,
      "default": function _default(el, parent) {
        var nodes = parent.querySelectorAll('input, textarea, select');
        return Array.from(nodes).reduce(function (carry, input) {
    ...
    validateEmpty: {
      type: Function,
      "default": function _default(el, parent) {
        var nodes = Array.from(parent.querySelectorAll('input, textarea, select')); // If one item left in the list, it should not be removed.

        if (parent.parentElement.children.length === 1) {
          return false;
        }

        return nodes.reduce(function (carry, input) {
          return input.value ? false : carry;
        }, true);
      }
    }
  ...
  data: function data() {
    var computedItems = [].concat(this.items);

    for (var i = computedItems.length; i < this.total; i++) {
  ...
  methods: {
    ...
    isLastChild: function isLastChild(el) {
      return this.indexOf(el) === el.parentElement.children.length - 1;
    },
    isFirstChild: function isFirstChild(el) {
      return this.indexOf(el) === 0;
    },
    bindEvents: function bindEvents(input, parent) {
      this.bindBlurEvent(input, parent);
      this.bindKeydownEvent(input, parent);
    },
    bindBlurEvent: function bindBlurEvent(input, parent) {
      var _this = this;

      input.addEventListener('blur', function (e) {
        var i = _this.indexOf(parent);

        if (!_this.isLastChild(parent) && _this.validateEmpty(input, parent)) {
          _this.computedItems.splice(i, 1);

          input.dispatchEvent(new Event('remove'));
          parent.querySelector('input, select, textarea').focus();

          _this.$emit('remove', parent, i);
        }
      });
    },
    bindKeydownEvent: function bindKeydownEvent(input, parent) {
      var _this2 = this;

      input.addEventListener('keydown', function (e) {
        var i = _this2.indexOf(parent);

        var nodes = Array.from(parent.querySelectorAll('input, select, textarea')); // If the keycode is not a tab, or the shift key is held
        ...
        if (_this2.isLastChild(parent) && _this2.validate(input, parent)) {
          if (_this2.computedItems.indexOf(i + 1) === -1) {
            _this2.computedItems.push(_this2.computedItems.length.toString());
          }
        }
      });
    },
    add: function add(input, parent) {
      var _this3 = this;

      return new Promise(function (resolve, reject) {
        var i = _this3.indexOf(parent);

        _this3.$nextTick(function () {
          _this3.$emit('add', parent.nextSiblingElement, i + 1);

          _this3.$nextTick(function () {
            return resolve(parent.nextSibling);
          });
        });
      });
    }
...
// CONCATENATED MODULE: ./src/InputList.vue?vue&type=script&lang=js&
 /* harmony default export */ var src_InputListvue_type_script_lang_js_ = (InputListvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./src/InputList.vue
...
var component = normalizeComponent(
  src_InputListvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var src_InputList = (component.exports);
...
/* harmony default export */ var lib_vue_loader_options_mainvue_type_script_lang_js_ = (src_InputList);
...
//# sourceMappingURL=InputList.umd.js.map